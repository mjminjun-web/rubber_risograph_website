...
class ColorMixer {
  ...
  init() {
    ...
    document
      .getElementById("rotateImg1Left")
      .addEventListener("click", () => this.rotateImage(1, -1));
    document
      .getElementById("rotateImg1Right")
      .addEventListener("click", () => this.rotateImage(1, 1));
    document
      .getElementById("rotateImg2Left")
      .addEventListener("click", () => this.rotateImage(2, -1));
    document
      .getElementById("rotateImg2Right")
      .addEventListener("click", () => this.rotateImage(2, 1));
  ...
  toggleSeparationMode() {
    ...
    if (btn) {
      btn.textContent = this.separationMode
        ? "Combined View"
        : "Separation View";
    }
    this.render();
  ...
  clear() {
    ...
    preview1.innerHTML =
      '<span class="empty-slot-text">🖼️ Click to select Image 1</span>';
    preview1.setAttribute("data-empty", "true");
    preview2.innerHTML =
      '<span class="empty-slot-text">🖼️ Click to select Image 2</span>';
